...
Rebuild the tools you use every day with your own hands. Recreate Real Systems - from scratch, in your language, in your IDE.

### Build your own X

This repository is a compilation of well-written, step-by-step guides for re-creating our favorite technologies from scratch.

{% embed url="https://github.com/codecrafters-io/build-your-own-x" %}

<figure><img src=".gitbook/assets/feynman.jpg" alt=""><figcaption></figcaption></figure>
...
CodeCrafters strive to provide a proper workout. You won't become a great swimmer by watching the Olympics on YouTube.
{% endhint %}
...
Head Over to `CodeCrafters` and try a FREE Project.

{% embed url="https://codecrafters.io/" %}

Redis, Git, SQLite, and 8 more real systems
{% endstep %}

{% step %}
### Code in your own setup

Your IDE, your extensions, your terminal. No toy editors
{% endstep %}

{% step %}
### Push and get feedback
